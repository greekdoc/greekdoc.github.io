...
-ος, -ος-α, -ον
			...
			var text1='ant'
			var text2='pen'
			</script><script src='js/adj/adj-steiros.js'></script>
...
*/
		...
		document.write("<table class='chart'>");
			...
			document.write("<tr><td class='green'>NOM</td><td class='chart'>"+text1+"ος</td><td class='chart'>"+text1+"α</td><td class='chart'>"+text1+"ον</td></tr>");
			...
			document.write("<tr><td class='green'>VOC</td><td class='chart'>"+text1+"ε</td><td class='chart'>"+text1+"α</td><td class='chart'>"+text1+"ε</td></tr>");

...
*/
		document.write("<table class='chart'>");
			...
			document.write("<tr><td class='green'>GEN</td><td class='chart'>"+text1+"οῦ</td><td class='chart'>"+text1+"ῆς<br>"+text2+"ης</td><td class='chart'>"+text1+"οῦ</td></tr>");

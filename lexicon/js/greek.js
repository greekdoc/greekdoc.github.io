...
text=text.replace(/i'\"/g, "&#8147;"); //iota acute dia
text=text.replace(/i\"'/g, "&#8147;"); //iota dia acute
text=text.replace(/i~\"/g, "&#8151;"); //
text=text.replace(/u`\"/g, "&#8162;"); //upsilon grave dia
text=text.replace(/u\"`/g, "&#8162;"); //upsilon dia grave
text=text.replace(/u\"'/g, "&#8163;"); //upsilon dia acute
text=text.replace(/u'\"/g, "&#8163;"); //upsilon acute dia
...
text=text.replace(/#o!/g, "&#1459;"); //qames  shewa
...
//text="<a href='http://www.motorera.com/greek/lexicon/"+first+".html#"+locate+"'><span class='greek'>"+text+"</span></a>"
text="<a href='../../lexicon/"+first+".html#"+locate+"'><span class='greek'>"+text+"</span></a>"

...
var text2;
		...
		document.write("<table class='chart'>");
			...
			document.write("<tr><th class='chart'>&nbsp;</th><th class='chart'>Masculine</th><th class='chart'>Feminine</th><th class='chart'>Neuter</th></tr>");
			document.write("<tr><td class='green'>NOM</td><td class='chart'>"+text2+"ονες<br />"+text2+"ους</td><td class='chart'>"+text2+"ονες<br />"+text2+"ους</td><td class='chart'>"+text2+"ονα<br />"+text2+"ω</td></tr>");
